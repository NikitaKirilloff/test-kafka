package kirilloff.restaurantservice.config;
...
public class KafkaConfiguration {
  ...
  @Bean
  public ConsumerFactory<String, ResponseEvent> responseEventConsumerFactory(
  ...
  public KafkaListenerContainerFactory<?> kafkaListenerContainerFactory(
      ConsumerFactory<String, ResponseEvent> responseEventConsumerFactory) {
